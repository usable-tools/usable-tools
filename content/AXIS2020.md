...
- **Identity: A Role Play Game** During the **9:00 PM ET** session, Sage Cheng (who leads design and UX work at Access Now) and Mona Wang (a security researcher at Princeton CITP) will facilitate “Identity: A Role Play Game”. Identity management has become a surviving skill in today's online world. This game is designed to help understand the scope of one's online identity and map out strategies to protect against adversaries. Learn more about the game here: https://pad.riseup.net/p/AXIS_Identity_ARolePlayGame_PM-keep
